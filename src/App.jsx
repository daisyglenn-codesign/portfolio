        ...
        <main className="mx-auto max-w-6xl px-6 py-10 lg:py-16">
            <section id="about" className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                <div className="space-y-6">
                    ...
                    <p className="max-w-2xl text-slate-300 sm:text-lg">I’m a driven Full-Stack Developer with years of hands-on experience designing and scaling web systems, optimizing workflows, and delivering end-to-end IT solutions. Grounded in core web architectures like PHP and modern JS frameworks, I focus on building reliable, clean, and practical software. Continuously refining my craft by expanding into Java, Kotlin, and Python to deliver versatile, adaptable engineering across modern tech stacks.</p>
